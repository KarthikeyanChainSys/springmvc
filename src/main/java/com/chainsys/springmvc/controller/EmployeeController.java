...
public class EmployeeController {
	...
	@PostMapping("/add")
	public String addNewEmployees(@ModelAttribute("addemployee") Emp theEmp) {
	...
	{
		Emp theEmp = EmployeeDao.getEmployeeById(id);
		model.addAttribute("updateemployee", theEmp);
		return "update-employee-form";
	}
	
	@PostMapping("/updateemp")
	public String updateEmployees(@ModelAttribute("updateemployee") Emp theEmp) {
